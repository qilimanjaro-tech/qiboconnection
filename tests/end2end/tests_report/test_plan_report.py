...
""",
    ...
    parser.add_argument("--dir", default=".", help="Base folder searching for tests")
    ...
    parser.add_argument(
        "--json_run", default="./logs/test_run.json", help="File with the combination of test plan + test results"
    )
    parser.add_argument("--out_report", default="./logs/test_run.html", help="HTML file with the test run")
    parser.add_argument("--tmpl_report", default="./test_run.html.tmpl", help="Template with the HTML")
