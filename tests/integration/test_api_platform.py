...
def fixture_temp_platform_settings(mocked_api: API, platform_schema: dict) -> Tuple[int, int]:
...
class TestAPIPlatformSchema:
    """Tests methods for API platform calls"""

    def test_create_platform_schema(self, mocked_api: API):
    ...
    def test_list_platform_schemas(self, mocked_api: API):
...
class TestAPIPlatformSettings:
    ...
    def test_create_platform_settings(self, mocked_api: API, platform_schema: dict):
    ...
    def test_read_platform_settings(self, mocked_api: API, platform_schema_id_settings_id: Tuple[int, int]):
    ...
    def test_update_platform_settings(self, mocked_api: API, platform_schema_id_settings_id: Tuple[int, int]):
        """test the read of a created platform settings"""
        platform_schema_id = platform_schema_id_settings_id[0]
        platform_settings_id = platform_schema_id_settings_id[1]
    ...
    def test_delete_platform_settings(self, mocked_api: API, temp_platform_schema_id_settings_id: Tuple[int, int]):
        """test the read of a created platform settings"""
        ...
        with pytest.raises((FileNotFoundError, ValueError)):
            mocked_api.read_platform_settings(
                platform_schema_id=platform_schema_id, platform_settings_id=platform_settings_id
            )
